    ...
    <nav className="fixed top-8 left-1/2 -translate-x-1/2 z-40 w-full max-w-fit px-4">
      ...
      >
        <div className="flex items-center gap-8">
          <a href="#" className="w-10 h-10 glass flex items-center justify-center font-bold text-lg text-blue-500 rounded-full">
            T
          </a>
          <div className="hidden md:flex items-center gap-8">
            ...
            <a
              ...
              className="flex items-center justify-center px-6 py-2 rounded-full bg-white text-black text-xs font-bold uppercase tracking-widest hover:scale-105 transition-transform"
            >
              Hire Me
            </a>
          </div>
